...
<!--           <p>Share: <? //php echo "http://rm29.org/event-detail.php?i=$i&id=$rand" ?></p>-->
           
           
           
       </div>
       <div class="col-sm-12" id="view">
          <div class="fb-share-button" data-href="https://www.rm29.org/event-detail.php" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.rm29.org%2Fevent-detail.php&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
